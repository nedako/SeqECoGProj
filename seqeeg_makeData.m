...
Dout  = seqeeg_parseEEG_PSD('ParseEEG-freqDecomp' , Dall, subjNum , 'Channels' , chans,'HilbertOrWavelet' , 'H');
Dout  = seqeeg_parseEEG_PSD('ParseEEG-calc_norm_PSD' , Dall, subjNum , 'Channels' , chans,'HilbertOrWavelet' , 'H');
...
% Dout  = seqeeg_parseEEG_PSD('AlignEvents_SeqType_ Warped' , Events, subjNum);
