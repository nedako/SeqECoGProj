...
switch what
        ...
        for BG = 1:length(blockGroups)
            ...
            if length(E1.SN{1})>0
                ...
                for sn = 1:length(E1.SN{1})
                    ...
                    E1.Rep{sn} = Rep;
                    clear tempPowTR tempPowBL tempPowAF Rep
                end
            else
                E1.PowTR{sn} = [];
                E1.PowBL{sn} = [];
    ...
    case 'binned_Power_SeqType'
        ...
        for bg = 1:length(blockGroups)
            ...
            if length(E1.SN{1})>0
                ...
                E1.NumWarpSamp([1 6 7 8 9 12 16 20]) = NumWarpSampFast;
                load(filename)
    ...
    case 'AlignedWarped_SeqType'
        ...
        for sn = 1:length(SeqTrans)
         ...
         for BG = 1:11%:length(blockGroups)
            P = [];
